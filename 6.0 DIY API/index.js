...
app.get("/jokes/:id",(req,res)=>{
  ...
  const foundJoke= jokes.find((mazak)=> mazak.id===id);
  res.json(foundJoke);
});
...
app.get("/filter", (req,res)=>{
 ...
 const filteredActivities= jokes.filter((mazak)=> mazak.jokeType===type);
...
const searchIndex= jokes.findIndex((mazak)=> mazak.id===id);
jokes[searchIndex]=newData;
res.json(newData);
});
